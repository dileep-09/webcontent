...
<nav class="navbar navbar-expand-lg stroke">
	<h2>
		<a class="navbar-brand mr-lg-1" href="index.jsp"> Farmer<span>
				Buddy</span>
		</a>
	</h2>
	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item"><a class="nav-link" href="customer-view-crops.jsp">View Crops</a></li>
			<li class="nav-item"><a class="nav-link" href="customer-view-insecticide.jsp">View Insecticides</a>
			</li>
			<li class="nav-item"><a class="nav-link" href="customer-view-equipments.jsp">View Equipments</a>
			</li>
			<li class="nav-item"><a class="nav-link" href="customer-view-pesticides.jsp">View Pesticides</a>
			</li>
			<li class="nav-item"><a class="nav-link" href="customer-sell-crops.jsp">Sell Crops</a></li>
			<li class="nav-item"><a class="nav-link" href="customer-feedback-or-complaints.jsp">Feedback OR Complaint</a></li>
			<li id="menu-item-26"
