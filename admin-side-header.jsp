	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item"><a class="nav-link" href="admin-manage-pesticides.jsp">Manage
					Pesticides</a></li>
			<li class="nav-item"><a class="nav-link" href="admin-view-buyers.jsp">View
					Buyers</a></li>
			...
			<li class="nav-item"><a class="nav-link" href="admin-view-all-farming-reports.jsp">View
					Reports</a></li>
			<li class="nav-item"><a class="nav-link" href="admin-view-feedback-or-complaints.jsp">View
					Feedback OR Complaints</a></li>
			<li id="menu-item-26"
