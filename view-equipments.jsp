			...
			<div class="container">
				...
				<ul class="breadcrumbs-custom-path mt-2">
					...
					<li class="active"><span class="fa fa-arrow-right mx-2"
						aria-hidden="true"></span>All Equipments</li>
				</ul>
			</div>
		</div>
	</section>
	...
	<div class="contact-form py-5" id="contact">
		<div class="container py-lg-5 py-md-4">
			<div class="contacts12-main mb-5">
				<form action="view-equipments.jsp" method="post">
					<div class="form-row">
						<div class="form-group col-md-10">
							<input type='text' class="form-control" id="equipments" name="equipments"
								placeholder="Equipment Name">
						</div>
						<div class="form-group col-md-2">
							<input type="submit" class="btn btn-primary" value="Search Equipments">
						</div>
					</div>
				</form>
				<br>
				...
				<div class="form-row">
					<div class="form-group col-md-2">
						<image src="uploads/<%=resultEquipments.getString("equipement_image_name")%>"
							style="width:130px;height:100px;"></image>
					</div>
					<div class="form-group col-md-10">
						<p>
						<h3><%=resultEquipments.getString("equipement_name")%></h3>
						</p>
						<p>
							<label style='color: #33b5e5;'><%=resultEquipments.getString("equipement_cost_range")%></label>
						</p>
						<p><%=resultEquipments.getString("description")%></p>
					</div>
				</div>
				<hr>
				<%
				...
				<div class="form-row">
					<div class="form-group col-md-2">
						<image src="uploads/<%=resultset.getString("equipement_image_name")%>"
							style="width:130px;height:100px;"></image>
					</div>
					<div class="form-group col-md-10">
						<p>
						<h3><%=resultset.getString("equipement_name")%></h3>
						</p>
						<p>
							<label style='color: #33b5e5;'><%=resultset.getString("equipement_cost_range")%></label>
						</p>
