	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="assets/images/feedback-complaint.jpg"
					style="width: 400px; height: 400px;">
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-info shadow p-3 mb-5">
					<div class="panel-heading">Customer Feedback OR Complaint</div>
					<div class="panel-body">
						<%
							...
							if (resultset.next()) {
						%>
						<form action="CustomerFeebacksOrComplaints" method="post">
							<div class="form-row">
								<div class="form-group col-md-12">
									<label for="cname">Customer Full Name:</label> <input
										type="text" class="form-control" id="cname"
										placeholder="Full Name" name="cname"
										value="<%=resultset.getString("full_name")%>" required readonly>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-12">
