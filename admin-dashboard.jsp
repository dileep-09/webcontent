		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
				<div class="alert alert-default back-widget-set text-center">
					...
					<%
						int buyerList=0;
						ResultSet resultBuyerCount=DatabaseConnection.getResultFromSqlQuery("select count(*) from tblbuyer");
						resultBuyerCount.next();
						buyerList=resultBuyerCount.getInt(1);
					%>
					<h3>
						<font color="#FF9933"><span class="counter"><%=buyerList%></span></font>
					</h3>
					<strong style="font-size: 22px;"><a href="admin-view-buyers.jsp" class="text-dark">View All Buyers</a></strong>
				</div>
			</div>
		</div>
	</div>
