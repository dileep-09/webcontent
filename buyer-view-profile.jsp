...
<body>
	...
	<header id="site-header" class="fixed-top">
		<div class="container-fluid">
			<jsp:include page="buyer-side-header.jsp"></jsp:include>
		</div>
	</header>
	<!-- //header -->
	<!-- about breadcrumb -->
	...
	<div class="container">
		...
		<div class="panel panel-primary shadow p-3 mb-5">
			...
			<div class="panel-body">
				...
				%>
				<%
					ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblbuyer where uname='"+ session.getAttribute("uname") + "' and email_id='" + session.getAttribute("email") + "'");
					if (resultset.next()) {
				%>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="buyerId">Buyer Id:</label> <input type="text"
								...
								name="buyerId" value="<%=resultset.getInt("id")%>" readonly>
						</div>
						<div class="form-group col-md-6"">
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="address">Address:</label> <textarea 
								...
								name="address" value="" required><%=resultset.getString("address") %></textarea>
						</div>
					</div>
