	...
	<div class="container">
		...
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-warning shadow p-3 mb-5" style="text-transform: uppercase">Farmer Buddy All
					Reports</div>
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light" style="text-transform: uppercase;font-size:small;font-weight: bold;">
						Farmer Buddy All Reports &nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]
					</div>
					<div class="panel-body">
