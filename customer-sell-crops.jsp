			...
			<div class="panel-body">
				...
				<form action="CustomerSellCrops" method="post">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<label for="buyerName">Buyer Name:</label> <select
								...
								<%
									ResultSet rsbuyer = DatabaseConnection.getResultFromSqlQuery("select * from tblbuyer");
									while (rsbuyer.next()) {
								%>
					...
					<%
						...
						ResultSet rsBuyerDetails = DatabaseConnection.getResultFromSqlQuery("select * from tblbuyer where full_name='" + buyerName + "'");
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td><%=resultSellingCrops.getString("buyer_name")%></td>
							<%
