...
<body>
	...
	<section class="w3l-about-breadcrumb text-left">
		<div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
			<div class="container">
				<h2 class="title">Buyer Account</h2>
				<ul class="breadcrumbs-custom-path mt-2">
					<li><a href="#url">Buyer</a></li>
	...
	<div class="container">
		<div class="panel panel-primary shadow p-3 mb-5">
			<div class="panel-body">
				...
				%>
				<div class="alert alert-success" id="success">Account created successfully.</div>
				<%
					}
				%>
				<form action="BuyerAccount" method="post" name="customerForm" id="form" role="form">
					<div class="form-row">
						<%
							int buyerId = DatabaseConnection.generateBuyerId();
						%>
						<div class="form-group col-md-6">
							<label for="buyerId">Buyer Id:</label> <input type="text"
								class="form-control" id="buyerId" placeholder="Buyer Id"
								name="buyerId" value="<%=buyerId%>" readonly>
						</div>
						<div class="form-group col-md-6"">
							<label for="fullname">Full Name:</label> <input type="text"
								class="form-control" id="fullname" placeholder="Full Name"
								name="fullname" required onkeypress="return lettersValidate(event)">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="email">Email Id:</label> <input type="text"
								...
								name="email" required title="Email can not be blank and should contain @ character.">
								
						</div>
						<div class="form-group col-md-6">
							<label for="mobile">Mobile No:</label> <input type="text"
								class="form-control" id="mobile" placeholder="Mobile No"
								name="mobile" required onkeypress="return numberValidate(event)" maxlength="10">
						</div>
					</div>
					<div class="form-row">
					...
					<input type="submit" value="Create Account" class="btn btn-primary" id="buttonValidate">
	...
	<script>
	 $(document).ready(function() {
         $("#buttonValidate").click(function() {
             ...
             var uname = $("#uname").val();
             var upass = $("#upass").val();
             if (fullname === "" || email === "" || mobile === "" || address === "" || uname === "" || upass === "")
             {
