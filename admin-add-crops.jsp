			...
			<div class="panel-body">
				...
				<form action="AdminAddCrops" method="post"
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="description">Description:</label> <textarea
								class="form-control" id="description" placeholder="Crop description"
					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<label for="file">Crop Image:</label> <input type="file"
