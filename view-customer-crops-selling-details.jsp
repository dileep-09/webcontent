	...
	<div class="container">
		...
		<div class="panel panel-info shadow p-3 mb-5">
			...
			<div class="panel-body">
				<%
					ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblsellcrops where sell_id='"+ request.getParameter("sellId") + "' and buyer_name='" + session.getAttribute("buyer-name") + "'");
					if (resultset.next()) {
				%>
				<form action="BuyerActionOnCustomerCrops" method="post">
					<div class="form-row">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="buyerName">Buyer Name:</label> <input type="text"
								...
								value="<%=resultset.getString("buyer_name")%>" readonly>
