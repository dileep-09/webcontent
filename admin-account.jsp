	...
	<div class="container">
		<div class="panel panel-warning shadow p-3 mb-5">
			...
			<div class="panel-body">
				...
				%>
				<form action="AdminAccount" method="post" name="customerForm" id="form" role="form">
					<div class="form-row">
						<%
							int adminId = DatabaseConnection.generateAdminId();
						%>
						<div class="form-group col-md-6">
							<label for="adminId">Admin Id:</label> <input type="text"
								class="form-control" id="adminId" placeholder="Admin Id"
								name="adminId" value="<%=adminId%>" readonly>
						</div>
						<div class="form-group col-md-6"">
