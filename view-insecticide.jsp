...
<body>
	...
	<section class="w3l-about-breadcrumb text-left">
		<div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
			<div class="container">
				<h2 class="title">View Insecticide</h2>
				<ul class="breadcrumbs-custom-path mt-2">
					<li><a href="#url">Home</a></li>
					<li class="active"><span class="fa fa-arrow-right mx-2"
						aria-hidden="true"></span>All Insecticide</li>
				</ul>
			</div>
		</div>
	</section>
	...
	<div class="contact-form py-5" id="contact">
		<div class="container py-lg-5 py-md-4">
			<div class="contacts12-main mb-5">
				<form action="view-insecticide.jsp" method="post">
					<div class="form-row">
						<div class="form-group col-md-10">
							<input type='text' class="form-control" id="insecticide" name="insecticide"
								placeholder="Insecticide Name">
						</div>
						<div class="form-group col-md-2">
							<input type="submit" class="btn btn-primary" value="Search Insecticide">
						</div>
					</div>
				</form>
				<br>
				<%
					String insecticideName = request.getParameter("insecticide");
					if (insecticideName != null) {
						ResultSet resultInsecticide = DatabaseConnection.getResultFromSqlQuery("select * from tblinsecticide where insecticide_name like '%" + insecticideName + "%' ");
							if (resultInsecticide.next()) {
				%>
				<div class="form-row">
					<div class="form-group col-md-2">
						<image src="uploads/<%=resultInsecticide.getString("insecticide_image_name")%>"
							style="width:130px;height:100px;"></image>
					</div>
					<div class="form-group col-md-10">
						<p>
						<h3><%=resultInsecticide.getString("insecticide_name")%></h3>
						</p>
						<p>
							<label style='color: #33b5e5;'><%=resultInsecticide.getString("insecticide_cost_range")%></label>
						</p>
						<p><%=resultInsecticide.getString("description")%></p>
					</div>
				</div>
				<hr>
				<%
				...
				<div class="form-row">
					<div class="form-group col-md-2">
						<image src="uploads/<%=resultset.getString("insecticide_image_name")%>"
							style="width:130px;height:100px;"></image>
					</div>
					<div class="form-group col-md-10">
						<p>
						<h3><%=resultset.getString("insecticide_name")%></h3>
						</p>
						<p>
							<label style='color: #33b5e5;'><%=resultset.getString("insecticide_cost_range")%></label>
						</p>
			...
			<div class="container py-lg-4">
				<div class="row footer-top-29">
					<div class="footer-list-29 col-lg-4">
						...
						<p class="pr-lg-5">The Farmer Buddy to override the
	...
	<section class="w3l-footer-29-main w3l-copyright">
		<div class="container">
			<div class="bottom-copies">
				<p class="copy-footer-29 text-center">© 2022 Farmer Buddy. All rights reserved.</p>
			</div>
		</div>
